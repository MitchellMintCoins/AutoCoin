...
unlocked to sign the Autocoin-Qt.app bundle.
...
allowing somebody to distribute a Autocoin-Qt.app or bitcoin-qt-setup.exe with a valid
...
that the autocoin-qt.exe file inside the installer had not been tampered with.
